...
* The original package name 'com.max.ai-dev-companion' is invalid and this project uses 'com.max.ai_dev_companion' instead.
...
* [Spring Reactive Web](https://docs.spring.io/spring-boot/3.5.15-SNAPSHOT/reference/web/reactive.html)
